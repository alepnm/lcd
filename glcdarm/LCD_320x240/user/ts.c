...
//		{
			do
				...
				Pen_Point.X=2047-((databuffer[1][3]+databuffer[1][4]+databuffer[1][5])/3);
				Pen_Point.Y=2047-((databuffer[0][3]+databuffer[0][4]+databuffer[0][5])/3);				
				
				//Pen_Point.X=((databuffer[1][3]+databuffer[1][4]+databuffer[1][5])/3);
				//Pen_Point.Y=((databuffer[0][3]+databuffer[0][4]+databuffer[0][5])/3);
...
void Convert_Pos(void)
{
	...
	Pen_Point.X0=(int)((Pen_Point.X - 50)/8);
	Pen_Point.Y0=(int)((Pen_Point.Y - 50)/6);
